...
import { getAuth, onAuth, onAuthStateChanged } from "firebase/auth";
...
function CreateListing() {
  ...
  const onSubmit = async (e) => {
    ...
    if(geolocationEnabled){
        const response=await fetch(`https://maps.googleapis.com/maps/api/geocode/json?address=${address}&key==A1zasAIt0ThhlwWSABx9e61HJte04sL1r`) 
